<div class="container">
    ...
    <h1>
        <a href="<?php echo siteUrl('/admin/articles/page/1');?>">Articles</a> / Créer
    </h1>
    <section id="article-form">



    <form action="<?php echo siteUrl();?>/admin/articles/creer" method="POST" enctype="multipart/form-data">
