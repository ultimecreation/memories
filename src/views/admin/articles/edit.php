<div class="container">
    ...
    <h1>
        <a href="<?php echo siteUrl('/admin/articles/page/1');?>">Articles</a> / Éditer
    </h1>
    <section id="article-form">



    <form action="<?php echo siteUrl('/admin/articles/editer/').$data['article']->article_id;?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="published">Approuver cet article</label>
        ...
        <input type="hidden" name="author_id" value="<?php echo $data['article']->author_id;?>">
